...
const CONFIG = {
  ...
  WA_RETRY_MAX_ATTEMPTS: envNumber("WA_RETRY_MAX_ATTEMPTS", 3),
  WA_RETRY_BASE_DELAY: envNumber("WA_RETRY_BASE_DELAY", 5000),
  WA_RETRY_MAX_DELAY: envNumber("WA_RETRY_MAX_DELAY", 30000),
  REMINDER_RETRY_BASE_DELAY: envNumber("REMINDER_RETRY_BASE_DELAY", 5 * 60 * 1000),
  REMINDER_RETRY_MAX_DELAY: envNumber("REMINDER_RETRY_MAX_DELAY", 60 * 60 * 1000),
};
